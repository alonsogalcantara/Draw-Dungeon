...
export const MISSION_CARDS: MissionCard[] = [
	...
	},
	{
		...
		description:
			'Un artefacto oscuro que susurra en tu mente. Pierdes algo de Comida lentamente por su influencia.',
		passiveEffect: {
		...
		deliveryTargets: [
			{
				roomType: 'merchant',
				reward: {
					label: 'Vendido a un buen precio',
					effects: [
						{ stat: 'gold', value: 8 },
						{ stat: 'food', value: 2 }
					]
			...
			},
			{
				roomType: 'shrine',
				reward: {
					label: 'Líneas místicas decodificadas',
					effects: [
						{ stat: 'xp', value: 3 },
						{ stat: 'hp', value: 3 }
					]
				...
				rewardDescription:
					'Decodificar en el Santuario: Obtienes +3 XP y +3 HP (Además revelará cartas de tu piso actual).'
			}
		]
	}
];
