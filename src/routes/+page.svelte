...
<svelte:head>
	...
	<meta
		name="description"
		content="Mini Rogue: A solitaire dungeon-crawling card game. Delve into the dungeon, room after room, to find the legendary Og's Blood."
	/>
	<link rel="preconnect" href="https://fonts.googleapis.com" />
	<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="anonymous" />
	<link
		href="https://fonts.googleapis.com/css2?family=Cinzel+Decorative:wght@400;700;900&family=Inter:wght@300;400;500;600;700;800;900&display=swap"
		rel="stylesheet"
	/>
</svelte:head>
...
<button
	class="fixed top-4 right-4 z-[60] flex h-10 w-10 items-center justify-center rounded-full border border-stone-700 bg-stone-900/80 text-lg text-stone-300 shadow-lg backdrop-blur-sm transition-all hover:scale-110 hover:bg-stone-800 active:scale-95"
